    ...
    <div class="container-fluid">
        <div class="row">
            <div class="card card-primary col-12 p-0">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form method="post" action="<?= base_url() ?>/datacontrol/kenaikan-kelas" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <a href="<?= base_url()?>/templateExcel/kenaikan_kelas.xlsx" id="template_download" class="btn btn-primary" download="kenaikan_kelas">Download Template File</a>
                        </div>
                        <div class="form-group">
                ...
                ?>
                <?php if (session()->get('tabel_kelas')) : ?>
                    <div class="col-12">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <?php
                                $no = 1;
                                foreach (session()->get('tabel_kelas') as $key => $value) : ?>
                                    <tr>
                                        <td class="text-center col-1"><?= $no++ ?></td>
                                        <td class="<?= ($value['nama_con'] != 0) ? "" : "bg-danger" ?>"><?= $value["nama"] ?></td>
                                        <td class="<?= ($value['kelas_con'] != 0) ? "" : "bg-danger" ?>"><?= $value["kmmi"] ?></td>
                                    </tr>
                                <?php endforeach;
                                ?>
                            </tbody>
                        ...
                        <div class="form-group">
                            ...
                            <a href="<?= base_url() ?>datacontrol/kenaikan-kelas/update" class="btn btn-primary">Update</a>
                            <a href="<?= base_url() ?>datacontrol/kenaikan-kelas/cencel" class="btn btn-primary">cencel</a>
                        </div>
                    </div>
                <?php endif; ?>
            </div>
