    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item active">Jadwal Imam maker</li>
        </ol>
      </div>
    </div>
  </div>
...
<div class="col-md-10 mx-auto">
  ...
  <div class="card card-primary">
    ...
    <!-- /.card-header -->
    <!-- form start -->
    <form method="POST" action="../form/print/imam">
      <div class="card-body">
        <p>Judul</p>
        ...
        <div class="input-group mb-3">
          <div class="input-group-prepend">
            ...
            <ul class="dropdown-menu">
              <li class="dropdown-item" onclick="insert_value(this)">Jadwal Imam Qo'ah kelas 6</li>
              <li class="dropdown-item" onclick="insert_value(this)">Jadwal Imam Qo'ah kelas 5</li>
            </ul>
          </div>
          <!-- /btn-group -->
        ...
        <div class="form-group">
          <p>waktu shalat</p>
          <select class="form-control select2bs4" style="width: 100%;" name="waktu[]" multiple required>
